...
## Corpus Check
- 141 files · ~420,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 541 nodes · 828 edges · 40 communities detected
...
Cohesion: 0.11
Nodes (13): patchPrefs(), refreshPrefs(), encodeAsciiLines(), sanitizeReceiptText(), concatParts(), escposPlainDivider(), escposPlainTableRow(), buildVendorReceiptEscPos() (+5 more)
...
Cohesion: 0.19
Nodes (7): applyServiceFeeDiscount(), calculateServiceFee(), formatServiceFeeReceiptLine(), escapeHtml(), openThermalReceiptReactPrintWindow(), locationFromBill(), vendorBillRowToThermalReceiptData()
...
- **Why does `ESCPOSBuilder` connect `Community 5` to `Community 4`?**
