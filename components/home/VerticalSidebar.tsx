export function VerticalSidebar() {
  return (
    <div className="fixed top-0 bottom-0 hidden lg:flex flex-col items-end justify-between py-14 z-40 pointer-events-none [right:max(12px,env(safe-area-inset-right))]">
      ...
      <div className="mb-6 flex flex-col items-end gap-3">
        <div className="pointer-events-none rounded-full border border-black/10 bg-white/80 px-3 py-3 shadow-lg backdrop-blur-md">
