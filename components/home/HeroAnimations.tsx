  ...
  return (
    <div className="relative flex flex-col items-center pt-48 md:pt-56 lg:pt-[220px] pb-20 md:pb-32 text-center px-4 md:px-8 z-10 w-full">
      ...
      <motion.div 
        ...
        className="mt-12 mb-10 flex flex-col sm:flex-row items-center gap-5"
      >
        <a 
          href="/dashboard" 
          className="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-full bg-white px-10 py-4 text-[15px] font-bold text-black shadow-[0_0_20px_rgba(255,255,255,0.15)] transition-all hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:scale-105 active:scale-95"
        >
          Open Customer App
        </a>
        <a 
          href="#segments" 
          className="w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-full bg-transparent px-10 py-4 text-[15px] font-bold text-zinc-300 shadow-sm ring-1 ring-inset ring-white/10 transition-all hover:bg-white/5 hover:-translate-y-1 active:scale-95 hover:text-white"
        >
          Explore Segments
        </a>
      </motion.div>
